        ...
        <div class="row">
            <div class="text-capitalize text-center">
                <h2><span style="color: darkblue">
                    <hr />
                    Department of Economics and Banking<hr />
                </span></h2>
            </div>
        </div>
        <div class="row">
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    ...
                    <li class="list-group-item clearfix"><a href="course-catalog.aspx?Dept=Economics%20Banking"><i class="fa fa-angle-right"></i>Course Catalog</a></li>
