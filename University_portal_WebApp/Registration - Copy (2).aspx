<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Registration - Copy (2).aspx.cs" Debug="true" EnableEventValidation="false" Inherits="Registration" %>
                            ...
                            <%--  <input type="checkbox"/>--%>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                                            ...
                                            <asp:Button ID="create_account_Button" type="submit" runat="server" Text="Create an account" OnClick="create_account_Button_Click" />
                                            
                                            <%--<button type="button" class="btn btn-default">Cancel</button>--%>
                                            <asp:Button ID="cancle_Button" type="button" class="btn btn-default" runat="server" Text="Cancel" />
                                        </div>
                                    </div>
